...
pred_df,error_df=base_line_model(sudden_df,auto_arima,'after')

pred_df.to_csv('../../result/sudden/auto_arima_sudden_window_after_prediction.csv',index=False)
error_df.to_csv('../../result/sudden/auto_arima_sudden_window_after_error.csv',index=False)