...
pred_df.to_csv('../../result/gradual/ar3_gradual_window_all_prediction.csv',index=False)
error_df.to_csv('../../result/gradual/ar3_gradual_window_all_error.csv',index=False)