...
pred_df,error_df=base_line_model(sudden_df,auto_ets,'all')

pred_df.to_csv('../../result/sudden/auto_ets_sudden_window_all_prediction.csv',index=False)
error_df.to_csv('../../result/sudden/auto_ets_sudden_window_all_error.csv',index=False)