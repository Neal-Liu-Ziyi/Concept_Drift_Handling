...
pred_df,error_df=base_line_model(sudden_df,ar_5,200)

pred_df.to_csv('../../result/sudden/ar5_sudden_window_200_prediction.csv',index=False)
error_df.to_csv('../../result/sudden/ar5_sudden_window_200_error.csv',index=False)