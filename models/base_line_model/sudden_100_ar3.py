...
pred_df,error_df=base_line_model(sudden_df,ar_3,100)

pred_df.to_csv('../../result/sudden/ar3_sudden_window_100_prediction.csv',index=False)
error_df.to_csv('../../result/sudden/ar3_sudden_window_100_error.csv',index=False)