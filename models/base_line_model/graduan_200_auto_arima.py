...
pred_df.to_csv('../../result/gradual/auto_arima_gradual_window_200_prediction.csv',index=False)
error_df.to_csv('../../result/gradual/auto_arima_gradual_window_200_error.csv',index=False)