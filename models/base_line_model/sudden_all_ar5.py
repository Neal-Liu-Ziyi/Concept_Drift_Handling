...
pred_df,error_df=base_line_model(sudden_df,ar_5,'all')

pred_df.to_csv('../../result/sudden/ar5_sudden_window_all_prediction.csv',index=False)
error_df.to_csv('../../result/sudden/ar5_sudden_window_all_error.csv',index=False)