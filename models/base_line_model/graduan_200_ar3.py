...
pred_df,error_df=base_line_model(gradual_df,ar_3,200)

pred_df.to_csv('../../result/incremental/ar3_gradual_window_200_prediction.csv',index=False)
error_df.to_csv('../../result/incremental/ar3_gradual_window_200_error.csv',index=False)