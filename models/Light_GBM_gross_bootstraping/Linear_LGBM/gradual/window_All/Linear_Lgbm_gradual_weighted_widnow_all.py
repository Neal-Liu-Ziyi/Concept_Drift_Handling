...
gradual_df.to_csv('Linear_gradual_cd_weighted_cv8_window_All.csv',index=False)
prediction_mean_df.to_csv('Linear_gradual_prediction_weighted_cv8_window_All.csv',index=False)