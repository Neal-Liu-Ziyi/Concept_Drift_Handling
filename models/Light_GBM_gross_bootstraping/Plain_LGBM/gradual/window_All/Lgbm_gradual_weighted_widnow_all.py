...
gradual_df.to_csv('Plain_LGBM_gradual_cd_cv8_window_All.csv',index=False)
prediction_mean_df.to_csv('Plain_LGBM_gradual_prediction_cv8_window_All.csv',index=False)