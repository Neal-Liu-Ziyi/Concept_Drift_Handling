...
incremental_df.to_csv('Incremental_cd_weighted_cv8_window200.csv',index=False)
prediction_mean_df.to_csv('Incremental_prediction_weighted_cv8_window200.csv',index=False)