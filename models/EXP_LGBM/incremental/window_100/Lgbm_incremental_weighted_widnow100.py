...
incremental_df.to_csv('Incremental_cd_weighted_cv8_window100.csv',index=False)
prediction_mean_df.to_csv('Incremental_prediction_weighted_cv8_window100.csv',index=False)